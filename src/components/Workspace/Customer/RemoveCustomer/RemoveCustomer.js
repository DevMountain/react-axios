  ...
  render() {
    return (
      <div id="RemoveCustomer__container">
        <button
          className="RemoveCustomer__removeBtn"
          onClick={this.toggle}
        ...
        {this.state.showConfirm ? (
          <div id="RemoveCustomer__confirmationContainer">
            <button id="RemoveCustomer__cancelBtn" onClick={this.toggle}>
              {' '}
              Cancel{' '}
            </button>
            <button className="RemoveCustomer__removeBtn" onClick={this.remove}>
              {' '}
              Confirm{' '}
            </button>
          </div>
